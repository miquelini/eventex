...
<object width="480" height="385">
  ...
  <embed src="http://www.youtube.com/v/{{ id }}"
    type="application/x-shockware-flash" allowscriptaccess="always"
...
def do_youtube(parser, token):
    try:
        # split_contents() knows not split quoted strings.
        tag_name, id_ = token.split_contents()
    except ValueError:
        raise TemplateSyntaxError, "%r tag requeries 1 argument" % \
